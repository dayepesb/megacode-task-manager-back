...
public class FileHandlerController {
    ...
    public ImageResponseDTO uploadImage(@RequestPart(value = PARAM_MULTIPART_FILE) MultipartFile file, @RequestParam(PARAM_TITLE)String title, @RequestParam(PARAM_COMMENTS)String comments, @RequestParam(PARAM_TYPE_IMAGE) Long typeImage) throws MegacodeException {
