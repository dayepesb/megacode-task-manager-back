...
public enum ErrorMessagesEnum {
    ...
    ERROR_TOKEN_EXPIRED(-16L,LABEL_TOKEN_EXPIRED),
    ERROR_TOKEN_CONVERSION(-17L,LABEL_TOKEN_CONVERSION),
    ERROR_USER_NO_ACTIVATE(-18L,LABEL_USER_INACTIVATE),
    ERROR_EMAIL_NO_REGISTER(-19L,LABEL_EMAIL_NO_REGISTER),
    ERROR_USER_VERIFY(-20L,LABEL_USER_VERIFY);
